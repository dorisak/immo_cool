...
class Bedroom(models.Model):
    ...
    superficy = models.DecimalField(max_digits=3, decimal_places=2)
    def __str__(self):
...
class Property(models.Model):
    ...
    def __str__(self):
        return "{} - {}".format(self.name, self.Administrator.first_name)
...
class Rental(models.Model):
    ...
    rent_amount = models.DecimalField(max_digits=4, decimal_places=2)
    ...
    def __str__(self):
        return "{} - {} - {}".format(self.Occupant.last_name, self.rent_amount, self.archived)
